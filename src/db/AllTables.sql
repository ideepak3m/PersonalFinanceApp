create table personal_finance.accounts (
  ...
  constraint accounts_provider_id_fkey foreign KEY (provider_id) references providers (id) on delete CASCADE,
...
create table personal_finance.belief_tags (
  ...
  constraint belief_tags_category_id_fkey foreign KEY (category_id) references category (id)
) TABLESPACE pg_default;
...
create trigger update_description_rules_updated_at BEFORE
update on description_rules for EACH row
execute FUNCTION update_updated_at_column ();
...
create table personal_finance.merchant (
  ...
  constraint merchant_category_id_fkey foreign KEY (category_id) references category (id)
) TABLESPACE pg_default;
...
create trigger update_product_metadata_updated_at BEFORE
update on product_metadata for EACH row
execute FUNCTION update_updated_at_column ();
...
create table personal_finance.products (
  ...
  constraint products_account_id_fkey foreign KEY (account_id) references accounts (id) on delete CASCADE,
...
create table personal_finance.transaction_split (
  ...
  constraint transaction_split_category_id_fkey foreign KEY (category_id) references category (id),
  constraint transaction_split_transaction_id_fkey foreign KEY (transaction_id) references transactions (id) on delete CASCADE
) TABLESPACE pg_default;
...
create table personal_finance.transactions (
  ...
  constraint transactions_normalized_merchant_id_fkey foreign KEY (normalized_merchant_id) references merchant (id),
...
create table personal_finance.user_preferences (
  ...
  constraint user_preferences_merchant_id_fkey foreign KEY (merchant_id) references merchant (id),
